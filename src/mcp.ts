    ...
    'get_device_readings',
    {
      ...
      inputSchema: {
        ...
        start_date: dateSchema
          .optional()
          .describe(
            'Start date in YYYY-MM-DD format. Must be paired with end_date.',
          ),
        end_date: dateSchema
          .optional()
          .describe(
            'End date in YYYY-MM-DD format. Must be paired with start_date.',
          ),
      },
      annotations: { readOnlyHint: true },
    },
    ...
    'get_device_graph',
    {
      ...
      inputSchema: {
        ...
        metric: metricSchema
          .optional()
          .describe(
            `Optional metric. Supported: ${supportedMetrics().join(', ')}.`,
          ),
      },
      annotations: { readOnlyHint: true },
    },
